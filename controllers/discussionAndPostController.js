...
exports.createDiscussion = async (req, res) => {
  await discPostModel.createDiscussion(
    req.session.userId,
    req.body.topicID,
    req.body.discussionSubject,
    req.body.discussionBody
  );
...
exports.createPost = async (req, res) => {
  await discPostModel
    .createPost(req.session.userId, req.body.discussionID, req.body.postBody)
    .then(([data, metadata]) => {
      res.redirect(
        301,
        '/discussionAndPostView?discussionID=' + req.body.discussionID
      );
    });
};
