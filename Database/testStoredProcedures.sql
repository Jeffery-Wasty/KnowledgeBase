...
CALL GET_USER_PER_USERNAME_PASSWORD('BEN', 'pass');
CALL GET_PRIVATE_USER_INFO(1);
CALL GET_PUBLIC_USER_INFO(1);
CALL MODIFY_USER(1, NULL, NULL, NULL, NULL, NULL, NULL);
CALL CREATE_USER('JJ', 'littlej', 'John', ' Hoang', 'johnquochoang@gmail.com', 'https://randomuser.me/api/portraits/med/men/2.jpg', 'Canada', '1920-04-06',
