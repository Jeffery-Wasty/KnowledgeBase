...
exports.test = async function test(){
	...
	console.log('\n\nTesting Messages');
    console.log((await pool.promise().query('CALL CREATE_MESSAGE(0, 1, \'What the heck is going on here\')'))[0]);
    console.log((await pool.promise().query('CALL GET_MESSAGES_FOR_CONVERSATION(0)'))[0]);
}
