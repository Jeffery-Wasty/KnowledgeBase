...
BEGIN
	SELECT 
        ...
        u.LAST_NAME,
        c.SUBJECT,
        DATE_FORMAT(DATE, "%b %e") as DATE,
        c.USER_ID_1 as SENDER,
        c.USER_ID_2 as RECEIVER,
        c.READ
...
BEGIN
    SELECT
        ...
        MESSAGE_BODY,
        DATE_FORMAT(DATE_TIME , "%b %e") as DATE,
...
BEGIN
    ...
    VALUES (@CONVERSATION_ID, _USER_ID, _DESTINATION_USER_ID, CURRENT_DATE(), _SUBJECT,1);
